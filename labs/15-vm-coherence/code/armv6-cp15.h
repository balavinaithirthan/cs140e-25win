...
{
    unsigned unified_p : 1,  // 0:1 0 = unified, 1 = seperate I/D
        _sbz0 : 7,           // 1-7:7
...
{
    unsigned MMU_enabled : 1,  // 0:1,   0 = MMU disabled, 1 = enabled,
