...
static inline pin_t pin_mem_attr_set(pin_t e, mem_attr_t mem)
{
    e.mem_attr = mem;
    return e;
}
...
static inline unsigned pin_nbytes(pin_t attr)
{
...
// aligned to 16mb, etc.
static inline unsigned pin_aligned(uint32_t va, pin_t attr)
{
...
static inline pin_t pin_mk(uint32_t G, uint32_t dom, uint32_t asid, mem_perm_t perm,
                           mem_attr_t mem_attr)
{
